  ...
  <div class="wrapper d-flex flex-column align-items-center">
    ...
    <div class="first-game-roulette">
      ...
      <form class="d-flex gap-4 mt-4">
        <div class="input-group">
          ...
          <input type="number" v-model="balance" name="balance" id="balance" class="form-control" placeholder="Ingrese su saldo">
        </div>
        <div class="input-group">
          <span class="input-group-text"><i class="fa-solid fa-coins"></i></span>
          <input type="number" name="bet" id="balance" class="form-control" placeholder="Ingrese su apuesta">
        </div>
      </form>
    </div>
    ...
    <div class="game-options text-center mt-5 d-flex flex-column">
      ...
      <div class="options mt-3 d-flex flex-column align-items-center">
        ...
        <div>
          <select name="betType" @change="getSelectedOption($event)" :disabled="(balance == 0)" id="betType" class="form-select">
